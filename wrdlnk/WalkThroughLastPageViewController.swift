...
class WalkThroughLastPageViewController: UIViewController, WalkThroughLastPageViewControllerDelegate {
    ...
    func createEnterButton() -> UIButton {
        let _button = UIButton(type: .system)
        let _imageView = UIImageView(image: UIImage(named: "pdf/yes"))
        _button.layer.cornerRadius = 4
        _button.layer.masksToBounds = true
        _button.translatesAutoresizingMaskIntoConstraints = false
        _button.addTarget(self, action: #selector(lastPageDone), for: .touchUpInside)
        _button.addSubview(_imageView)
        return _button
    }
    
    @objc func lastPageDone() {
    ...
    override func viewDidLoad() {
        ...
        self.keyViewDictionary = self.contentPlist[3]
    ...
    func setupMainTitleLabel() {
        ...
        mainTitleLabel.topAnchor.constraint(equalTo: view.centerYAnchor, constant: -27).isActive = true
    ...
    func setupFirstSubTitleLabel() {
        ...
        firstSubTitleLabel.topAnchor.constraint(equalTo: mainTitleLabel.bottomAnchor).isActive = true
    ...
    func setupEnterButton() {
        ...
        enterButton.centerYAnchor.constraint(equalTo: pageControl.bottomAnchor, constant: 20).isActive = true
        enterButton.widthAnchor.constraint(equalToConstant: 46).isActive = true
