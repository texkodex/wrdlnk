...
class WalkThroughTwoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.keyViewDictionary = self.contentPlist[1]
...
//        let nextView:WalkThroughThreeViewController = storyboard.instantiateViewController(withIdentifier: "WalkThroughThreeViewController") as! WalkThroughThreeViewController
//        
